"""Tests for O6 VersionManager with hardware."""
...
from linkerbot.hand.o6 import DeviceInfo, Version
...
class TestDeviceInfo:
    ...
    def test_get_device_info_returns_complete(self, o6_hand: O6):
        """get_device_info should return a DeviceInfo with all fields populated."""
        info = o6_hand.version.get_device_info()
    ...
    def test_serial_number_format(self, o6_hand: O6):
    ...
    def test_version_format(self, o6_hand: O6):
    ...
    def test_device_info_has_timestamp(self, o6_hand: O6):
    ...
    def test_timestamp_progression_and_full_validation(self, o6_hand: O6):
        """Two consecutive calls should have increasing timestamps; second fully validated."""
        info1 = o6_hand.version.get_device_info()
        time.sleep(0.2)
        info2 = o6_hand.version.get_device_info()
