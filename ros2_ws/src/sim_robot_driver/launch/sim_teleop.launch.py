...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # The MuJoCo process deliberately uses the dedicated Python 3.10
        # environment.  It has both rclpy and mujoco; hardware nodes do not
        # inherit this choice and retain the ordinary ROS2 runtime.
        ExecuteProcess(cmd=[
