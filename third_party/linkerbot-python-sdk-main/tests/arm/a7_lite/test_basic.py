"""Tests for A7lite arm basic functionality with hardware."""
...
pytestmark = [pytest.mark.a7_lite, pytest.mark.basic]
...
class TestReadArmState:
    ...
    def test_read_arm_state_read(self, a7_lite_arm: A7lite):
        arm_state = a7_lite_arm.get_state()
    ...
    def test_read_arm_state_update(self, a7_lite_arm: A7lite):
        """Test reading arm state."""
        arm_state = a7_lite_arm.get_state()
        time.sleep(1.5)
        arm_state_updated = a7_lite_arm.get_state()
