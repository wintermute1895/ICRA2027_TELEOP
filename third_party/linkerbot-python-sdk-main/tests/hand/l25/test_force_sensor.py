...
# Hardware-verified open pose for baseline
OPEN = [
    100.0,
    100.0,
    100.0,
...
class TestForceSensorBlocking:
    ...
    def test_blocking_double_read_and_baseline(self, l25_hand: L25):
        ...
        # First read
        data1 = l25_hand.force_sensor.get_blocking(timeout_ms=2000)
        ...
        # Second read
        data2 = l25_hand.force_sensor.get_blocking(timeout_ms=2000)
    ...
    def test_each_finger_accessible(self, l25_hand: L25):
    ...
    def test_per_finger_pressure(
        ...
        for name in FINGER_NAMES:
            ...
            def _read_and_print(n: str = name) -> None:
                data = l25_hand.force_sensor.get_finger(n).get_blocking(timeout_ms=2000)
...
class TestForceSensorStreaming:
    ...
    def test_streaming_all_fingers_detected(self, l25_hand: L25):
        ...
        try:
            l25_hand.start_polling({SensorSource.FORCE_SENSOR: 0.05})
            ...
            while time.monotonic() < deadline:
                ...
                snapshot = l25_hand.force_sensor.get_snapshot()
                if snapshot is None:
                    continue
