"""Stress tests: binary search for minimum polling interval on O6."""
...
from linkerbot.hand.o6 import AngleEvent, ForceSensorEvent, SensorSource

pytestmark = [pytest.mark.o6, pytest.mark.stress]
...
class TestPollingIntervalStress:
    ...
    def test_angle_interval(self, o6_hand: O6):
    ...
    def test_force_sensor_interval(self, o6_hand: O6):
    ...
    def test_combined_interval(self, o6_hand: O6):
...
class TestInterleavedReadDuringPolling:
    ...
    def test_speed_read_during_polling(self, o6_hand: O6):
