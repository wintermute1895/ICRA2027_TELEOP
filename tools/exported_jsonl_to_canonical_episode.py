...
def main() -> int:
    ...
    for row in rows:
        ...
        command_rows.append({
            ...
            "raw_action_rad": row.get("raw_action_rad", row.get("master_joint_raw")),
            "candidate_action_rad": row.get("candidate_action_rad"),
            "correction_probability": row.get("correction_probability"),
            "learned_gain": row.get("learned_gain"),
            "composed_action_rad": row.get("composed_action_rad", filter_output),
            "issued_action_rad": row.get("issued_action_rad"),
            "filter_inference_header_stamp_ns": row.get("filter_inference_header_stamp_ns"),
            "filter_authority_mode": row.get("filter_authority_mode"),
            "filter_safety_reasons": row.get("filter_safety_reasons"),
            "filter_visual_embedding": row.get("filter_visual_embedding"),
