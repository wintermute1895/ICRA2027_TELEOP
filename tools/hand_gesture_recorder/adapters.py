...
class O6Hand:
    ...
    def __init__(self, side="left", can="can0"):
        ...
        self.hand = O6Hand(side=side, interface_name=can)
        self.hand.connect()
    def read(self): return self.hand.get_angles(timeout_ms=500)
    def write(self, values): self.hand.set_angles(values)
    def close(self): self.hand.disconnect()
